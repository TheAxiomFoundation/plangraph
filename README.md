...
lower-priority predecessor ahead of unrelated work. An underway item pulls nothing ahead,
since it waits for nothing. Ids break ties for scarce capacity. It is a serial heuristic, not
an optimizer.
